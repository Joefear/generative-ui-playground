...
> The latest version lives at [`examples/showcases/generative-ui-playground`](https://github.com/CopilotKit/CopilotKit/tree/main/examples/showcases/generative-ui-playground).
