...
import { createCalculator, inputCalculator, evaluateExpression, clearHistory, } from "./src/calculator.js";
// Import todo logic (NEW)
import { createTodoList, addTodoItem, completeTodoItem, reopenTodoItem, deleteTodoItem, clearCompleted, } from "./src/todo.js";
...
const getServer = async () => {
    ...
    server.registerTool("select-flight", {
        title: "Select Flight",
    ...
    server.registerTool("select-seats", {
        title: "Select Seats",
    ...
    server.registerTool("book-flight", {
        title: "Book Flight",
    ...
    server.registerTool("search-hotels", {
        title: "Search Hotels",
    ...
    }, async ({ city, checkIn, checkOut, guests, rooms }) => {
        try {
    ...
    server.registerTool("select-hotel", {
        title: "Select Hotel",
    ...
    server.registerTool("select-room", {
        title: "Select Room",
    ...
    server.registerTool("book-hotel", {
        title: "Book Hotel",
    ...
    server.registerTool("execute-trade", {
        ...
        const result = executeTrade(portfolioId, action, symbol, quantity);
        if (!result.success) {
            return {
                content: [{ type: "text", text: result.message }],
                structuredContent: { success: false, error: result.message },
    ...
    server.registerTool("open-calculator", {
    ...
    server.registerTool("input-calculator", {
    ...
    server.registerTool("evaluate-expression", {
    ...
    server.registerTool("clear-calculator-history", {
    ...
    server.registerTool("open-todo-list", {
    ...
    server.registerTool("add-todo-item", {
        title: "Add Todo Item",
    ...
    }, async ({ listId, title, description, priority, dueDate, tags }) => {
    ...
    server.registerTool("complete-todo-item", {
    ...
    server.registerTool("reopen-todo-item", {
    ...
    server.registerTool("delete-todo-item", {
    ...
    server.registerTool("clear-completed-todos", {
