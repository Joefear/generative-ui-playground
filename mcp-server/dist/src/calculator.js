 ...
 */
export function inputCalculator(calculatorId, input) {
 ...
 */
export function evaluateExpression(calculatorId, expression) {
    const state = calculators.get(calculatorId);
    if (!state) {
        return { success: false, message: "Calculator not found" };
    }
 ...
 */
export function getHistory(calculatorId) {
    const state = calculators.get(calculatorId);
 ...
 */
export function clearHistory(calculatorId) {
    const state = calculators.get(calculatorId);
    if (!state) {
        return { success: false, message: "Calculator not found" };
    }
